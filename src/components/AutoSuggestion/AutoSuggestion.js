    ...
    return (
      <div>
        ...
        {editAutoSuggestion && (
          ...
          >
            <DialogTitle id="alert-dialog-title">
              {'Update Auto Suggestion Statement'}
            </DialogTitle>
            <DialogContent>
              <form className={classes.w100}>
                <Row>
        ...
        {visibleInfo && (
          ...
          >
            <DialogTitle id="alert-dialog-title">
              {'Auto Suggestion Instructions'}
            </DialogTitle>
            <DialogContent>
              <ol>
                <li>
                  Go into some quiet spot{' '}
                  <strong>(preferably in bed at night)</strong> where you will
                  not be disturbed or interrupted. Close your eyes and repeat
                  aloud <strong>(so you may hear your own words)</strong>
                  <ul>
                    <li>
                      the written statement of the amount of money you intend to
                      accumulate,
                    </li>
                    <li>the time limit for its accumulation,</li>
                    <li>
                      and a description of the service or merchandise you intend
                      to give in return for the money.
                    </li>
                  </ul>
                  As you carry out these instructions, see yourself already in
                  possession of the money. For example: suppose you intend to
                  accumulate $100,000 by the first of June 2019 and you intend
                  to give personal services in return for the money in the
                  capacity of a software developer. Your written statement of
                  your purpose is similar to the following:
                </li>
                <li>
                  Repeat this program night and morning until you can see (in
                  your imagination) the money you intend to create!
                </li>
                <li>
                  Place a written copy of your statement where you can see it
                  night and morning. Read it just before retiring and upon
                  rising until it is memorized and part of your soul!
                </li>
                <li>
                  Read the entire chapter aloud once every night until you
                  become thoroughly convinced that the principle of
                  AUTO-SUGGESTION is sound, that it will accomplish for you all
                  that has been claimed for it. As you read, underline with a
                  pencil every sentence that impresses you favorably!
                </li>
              </ol>
            </DialogContent>
          </Dialog>
        ...
        <Grid container spacing={16}>
          ...
          {(affirmations == null || affirmations.length === 0) && (
            <Grid item xs={12} sm={6} lg={4} key={`affirmationContainer-0`}>
              <BasicImageCard
